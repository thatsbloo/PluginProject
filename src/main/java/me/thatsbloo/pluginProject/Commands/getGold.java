    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        if (args.length == 0) {
            if (sender instanceof Player) {
                ...
                sender.sendMessage("This command can only be used by players, if you wish to check out someone's gold do /getgold <player>.");
            }
            ...
            p.sendMessage(p.getDisplayName() + "§r's current gold is: §l§6" + gold);
