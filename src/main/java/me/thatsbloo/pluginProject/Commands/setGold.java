...
public class setGold implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (args.length == 1) {
            ...
            pdc.set(PluginProject.keyGold, PersistentDataType.INTEGER, value);
            p.sendMessage("§rGold value set to: §l§6" + value);
            ...
            PersistentDataContainer pdc = p.getPersistentDataContainer();
            pdc.set(PluginProject.keyGold, PersistentDataType.INTEGER, value);
            p.sendMessage("§rGold value of " + p.getDisplayName() + " set to: §l§6" + value);
        }
